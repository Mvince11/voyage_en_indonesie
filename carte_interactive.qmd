...
map = {
  const container = html` <div style="width: 100%; display: flex;">
    <div id="map-container" style="flex: 2; height: 672px;"></div>
  </div>`;
  yield container;
    ...
    // Ajoute un gestionnaire de clic au marqueur
      el.addEventListener('click', () => {
        ...
        sidebar.innerHTML = `
          ...
          <img src="${m.photo1}" alt="${m.title}" style="width: 100%; border-radius: 10px; margin: 10px 0;">
          <p>${m.description}</p>
          ...
          <img src="${m.photo2}" alt="${m.title}" style="width: 100%; border-radius: 10px; margin: 10px 0;">
          <img src="${m.photo3}" alt="${m.title}" style="width: 100%; border-radius: 10px; margin: 10px 0;">
        `;
      });
